class DropBoxController {
    ...
    removeFolderTask(fileData){

        return new Promise((resolve, reject)=>{

            let folderRef = this.getFirebaseRef(fileData.path + '/' + fileData.name);
            ...
            folderRef.on('value', snapshot => {
                ...
                snapshot.forEach(item => {
                    ...
                    if (data.type === 'folder') {
                        ...
                        this.removeFolderTask(data).then(r=>{
                        ...
                        this.removeFile(data.ref).then(e => {
    ...
    removeFile(ref, name) {
        ...
        let fileRef = firebase.storage().ref(ref).child();
    ...
    uploadProgress(event, file) {
        ...
        let timeleft = (100 - percent) * timespent;
